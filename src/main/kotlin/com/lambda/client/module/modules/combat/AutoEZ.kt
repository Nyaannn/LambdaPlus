...
object AutoEZ : Module(
    ...
    private enum class MessageMode(val text: String) {
        GG("gg, $NAME"),
        ONTOP("Lambda+ on top!, Ezzz $NAME"),
        EZD("$NAME just got ez'd by by Lambda+"),
        EZ_HYPIXEL("$HYPIXEL_MESSAGE $NAME"),
        NAENAE("You just got naenae'd by Lambda+, $NAME"),
        MCDONALDS("$NAME Get off your lazy ass and try getting a job at McDonalds maybe then you will be actually worth something"),
        CUSTOM("");
    }
