...
object CrystalAura : Module(
    ...
    private val placeDelayMs by setting("Place Delay ms", 30, 1..500, 1, page.atValue(Page.PLACE_TWO, placeDelayMode.atValue(PlaceDelayMode.MS)))
    private val placeRange by setting("Place Range", 4.25f, 0.0f..7.0f, 0.25f, page.atValue(Page.PLACE_TWO))
    private val wallPlaceRange by setting("Wall Place Range", 3.5f, 0.0f..7.0f, 0.25f, page.atValue(Page.PLACE_TWO))
