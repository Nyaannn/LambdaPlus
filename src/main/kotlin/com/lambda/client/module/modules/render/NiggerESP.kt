...
object NiggerESP : Module(
    name = "NiggerESP",
    description = "Nametags but adds nigger after the name",
        ...
        safeListener<TickEvent.ClientTickEvent> {
            ...
            for ((entity, textComponent) in entityMap) {
                ...
                if (entity is EntityXPOrb) {
                    textComponent.add(entity.name + " <--- NIGGER")
    ...
    private fun getContent(contentType: ContentType, entity: Entity) = when (contentType) {
        ...
        ContentType.NAME -> {
            val name = entity.displayName.unformattedText  + " <--- NIGGER"
